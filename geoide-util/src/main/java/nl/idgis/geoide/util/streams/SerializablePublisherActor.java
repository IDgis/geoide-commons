...
public class SerializablePublisherActor extends UntypedActor {
	...
	public SerializablePublisherActor (final Publisher<?> publisher, final long timeoutInMillis) {
		this.publisher = publisher;
		this.timeoutInMillis = timeoutInMillis;
	}
	
	public static <T> Props props (final Publisher<T> publisher, final long timeoutInMillis) {
		if (publisher == null) {
