...
public class MapConfig {
	...
	public MapProviderApi mapProviderApi (final MapProvider mapProvider) {
		return new MapProviderApi () {
			...
			@Override
			public CompletableFuture<List<QueryDescription>> getQueryDescriptions (final String mapId) {
				return CompletableFuture.completedFuture (mapProvider.getQueryDescriptions (mapId));
			}
		};
	}
}
