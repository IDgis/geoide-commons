...
object Common {
	val geoideCommonsVersion = "1.0.0"
	...
	object Dependencies {
		...
		val geoideDomain = "nl.idgis.geoide" % "geoide-domain" % "1.0.0"
		val geoideUtil = "nl.idgis.geoide" % "geoide-util" % "1.0.0"
		val geoideRemote = "nl.idgis.geoide" % "geoide-remote" % "1.0.0"
