...
object Common {
	val geoideCommonsVersion = "0.1.0"
	...
	object Dependencies {
		val geoideDomain = "nl.idgis.geoide" % "geoide-domain" % "0.1.0"
		val geoideDomainTest = "nl.idgis.geoide" % "geoide-domain-test" % "0.1.0"
		val geoideOL3 = "nl.idgis.geoide" % "geoide-ol3" % "0.1.0"
		val geoideUtil = "nl.idgis.geoide" % "geoide-util" % "0.1.0"
		val geoideServiceCommon = "nl.idgis.geoide" % "geoide-service-common" % "0.1.0"
		val geoideServiceTms = "nl.idgis.geoide" % "geoide-service-tms" % "0.1.0"
		val geoideServiceWms = "nl.idgis.geoide" % "geoide-service-wms" % "0.1.0"
		val geoideServiceWfs = "nl.idgis.geoide" % "geoide-service-wfs" % "0.1.0"
		val geoideLayerCommon = "nl.idgis.geoide" % "geoide-layer-common" % "0.1.0"
		val geoideLayerDefault = "nl.idgis.geoide" % "geoide-layer-default" % "0.1.0"
		val geoidePrint = "nl.idgis.geoide" % "geoide-print" % "0.1.0"
		val geoideHttpClient = "nl.idgis.geoide" % "geoide-http-client" % "0.1.0"
		val geoideMap = "nl.idgis.geoide" % "geoide-map" % "0.1.0"
