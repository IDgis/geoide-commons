...
object Common {
	val geoideCommonsVersion = "1.0.2-SNAPSHOT"
	...
	object Dependencies {
		...
		val geoideDomain = "nl.idgis.geoide" % "geoide-domain" % "1.0.2-SNAPSHOT"
		
		val geoideUtil = "nl.idgis.geoide" % "geoide-util" % "1.0.2-SNAPSHOT"
		val geoideRemote = "nl.idgis.geoide" % "geoide-remote" % "1.0.2-SNAPSHOT"
		
		val webjarsPlay = "org.webjars" %% "webjars-play" % "2.3.0"
  		val webjarsBootstrap = "org.webjars" % "bootstrap" % "3.2.0"
  		val webjarsDojoBase =  "nl.idgis.webjars" % "dojo-base" % "1.10.0-1"
